...
public class UserController extends BaseController {
	...
	public ModelAndView saveU(PrintWriter out) throws Exception{
		...
		pd = this.getPageData();
		//获取最大id
		String UID = String.valueOf(Integer.parseInt(userService.findMaxId(pd).get("UID").toString())+1);
...
//				}
				...
				pd.put("PASSWORD", "123");	//默认密码123  new SimpleHash("SHA-1", USERNAME, "123").toString()
				if(userService.findByUN(pd) != null){
					continue;
				}
				userService.saveU(pd);
